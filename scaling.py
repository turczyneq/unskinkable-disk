...
plt.errorbar(disk4[:,0], disk4[:,2], xerr=disk4[:,1], yerr=disk4[:,3], fmt='o', label=r"Disk radius $R = 4$ cm")
plt.errorbar(disk6[:,0], disk6[:,2], xerr=disk6[:,1], yerr=disk6[:,3], fmt='s', color='#d39400', label=r"Disk radius $R = 6$ cm")
plt.errorbar(disk8[:,0], disk8[:,2], xerr=disk8[:,1], yerr=disk8[:,3], fmt='o', mfc='w',color='g', label=r"Disk radius $R = 8$ cm")
